...
window.onload = function () {
  ...
  telefone.addEventListener('focus', function (e) {
    if (current) current.pause();
    current = anime({
      targets: '#form3',
      strokeDashoffset: [anime.setDashoffset, 0],
...
module.exports = __webpack_require__(/*! G:\xampp\htdocs\m2\resources\js\custom.js */"./resources/js/custom.js");
